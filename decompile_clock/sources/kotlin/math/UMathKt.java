...
public final class UMathKt {
    ...
    private static final int m1424minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1403minOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1425mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1411minOfeb3DHEI(j, j2);
    }

    /* JADX INFO: renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1422maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1391maxOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1423maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1399maxOfeb3DHEI(j, j2);
    }
}
