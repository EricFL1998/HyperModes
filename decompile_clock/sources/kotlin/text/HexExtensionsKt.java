...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        if (0 > j || j > 2147483647L) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m424toStringimpl(ULong.m378constructorimpl(j))));
        }
        return (int) j;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:66:0x0151 A[SYNTHETIC] */
            ...
            if (i14 == bytesPerLine) {
                ...
                if (i15 == bytesPerGroup) {
                    ...
                    if (str4.length() == 0) {
                        ...
                        while (i16 < length4) {
                            int i17 = i14;
                            int i18 = length4;
                            if (!CharsKt.equals(groupSeparator.charAt(i16), str.charAt(length3 + i16), ignoreCase$kotlin_stdlib)) {
                    ...
                    if (i15 != 0) {
                        ...
                        if (str5.length() == 0) {
                            ...
                            while (i20 < length5) {
                                int i21 = length5;
                                int i22 = i15;
                                if (!CharsKt.equals(byteSeparator.charAt(i20), str.charAt(length3 + i20), ignoreCase$kotlin_stdlib)) {
                ...
                if (str2.length() == 0) {
                    ...
                    while (i7 < length) {
                        int i24 = length;
                        int i25 = i6;
                        if (!CharsKt.equals(bytePrefix.charAt(i7), str.charAt(length3 + i7), ignoreCase$kotlin_stdlib)) {
                ...
                if (str3.length() == 0) {
                    ...
                    while (i10 < length2) {
                        int i26 = i9;
                        if (!CharsKt.equals(byteSuffix.charAt(i10), str.charAt(length3 + i10), ignoreCase$kotlin_stdlib)) {
