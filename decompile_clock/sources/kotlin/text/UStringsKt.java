...
public final class UStringsKt {
    ...
    public static final String m1551toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1553toStringolVBNx4(short s, int i) {
    ...
    public static final String m1552toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1550toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m299constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m216boximpl(UByte.m222constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m299constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m479boximpl(UShort.m485constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM299constructorimpl = UInt.m299constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM299constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM299constructorimpl2 = UInt.m299constructorimpl(i3 * iM299constructorimpl);
            int iM299constructorimpl3 = UInt.m299constructorimpl(UInt.m299constructorimpl(iDigitOf) + iM299constructorimpl2);
            if (Integer.compareUnsigned(iM299constructorimpl3, iM299constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM299constructorimpl3;
        }
        return UInt.m293boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM378constructorimpl = ULong.m378constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM378constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM378constructorimpl2 = ULong.m378constructorimpl(j * jM378constructorimpl);
            long jM378constructorimpl3 = ULong.m378constructorimpl(ULong.m378constructorimpl(((long) UInt.m299constructorimpl(iDigitOf)) & 4294967295L) + jM378constructorimpl2);
            if (Long.compareUnsigned(jM378constructorimpl3, jM378constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM378constructorimpl3;
        }
        return ULong.m372boximpl(j);
    }
}
