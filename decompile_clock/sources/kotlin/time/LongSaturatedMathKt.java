...
public final class LongSaturatedMathKt {
    ...
    public static final long m1663saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM1603toLongimpl = Duration.m1603toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m1662checkInfiniteSumDefinedPjuGub4(j, j2, jM1603toLongimpl);
        }
        if ((1 | (jM1603toLongimpl - 1)) == Long.MAX_VALUE) {
            return m1664saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM1603toLongimpl;
        if (((j ^ j3) & (jM1603toLongimpl ^ j3)) < 0) {
    ...
    private static final long m1662checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m1589isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m1664saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM1567divUwyO8pc = Duration.m1567divUwyO8pc(j2, 2);
        long jM1603toLongimpl = Duration.m1603toLongimpl(jM1567divUwyO8pc, durationUnit);
        return (1 | (jM1603toLongimpl - 1)) == Long.MAX_VALUE ? jM1603toLongimpl : m1663saturatingAddNuflL3o(m1663saturatingAddNuflL3o(j, durationUnit, jM1567divUwyO8pc), durationUnit, Duration.m1592minusLRDsOJo(j2, jM1567divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m1654getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m1653getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m1608unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m1593plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m1608unaryMinusUwyO8pc(infinityOfSign(j3));
        }
