...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static int m361hashCodeimpl(int[] iArr) {
        return Arrays.hashCode(iArr);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m365toStringimpl(int[] iArr) {
    ...
    public boolean m366addWZ4Q5Ns(int i) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean equals(Object other) {
        return m357equalsimpl(this.storage, other);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m367containsWZ4Q5Ns(((UInt) obj).getData());
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int[] m353constructorimpl(int i) {
        return m354constructorimpl(new int[i]);
    }

    /* JADX INFO: renamed from: get-pVg5ArA, reason: not valid java name */
    public static final int m359getpVg5ArA(int[] iArr, int i) {
        return UInt.m299constructorimpl(iArr[i]);
    }

    /* JADX INFO: renamed from: set-VXSXFK8, reason: not valid java name */
    public static final void m364setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m360getSizeimpl(int[] iArr) {
        return iArr.length;
    }
    ...
    public static java.util.Iterator<UInt> m363iteratorimpl(int[] iArr) {
    ...
    private static final class Iterator implements java.util.Iterator<UInt>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UInt next() {
            return UInt.m293boximpl(m369nextpVg5ArA());
        }
    ...
    public boolean m367containsWZ4Q5Ns(int i) {
        return m355containsWZ4Q5Ns(this.storage, i);
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public static boolean m355containsWZ4Q5Ns(int[] iArr, int i) {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m356containsAllimpl(this.storage, elements);
    }

    /* JADX INFO: renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m356containsAllimpl(int[] iArr, Collection<UInt> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m362isEmptyimpl(int[] iArr) {
