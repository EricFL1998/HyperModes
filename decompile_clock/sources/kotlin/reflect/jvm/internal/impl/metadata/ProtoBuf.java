...
public final class ProtoBuf {
    ...
    public static final class Class extends GeneratedMessageLite.ExtendableMessage<Class> implements ClassOrBuilder {
                    ...
                    try {
                        ...
                        switch (tag) {
                            ...
                            case R2.array.timezone_search_bottom_sheet_mode_config /* 162 */:
                                ...
                                z = true;
                                break;
                            case R2.attr.NumberPickerStyle /* 168 */:
                                if ((i & 256) != 256) {
                                ...
                                z = true;
                                break;
                            case R2.attr.SharedValueId /* 170 */:
                                ...
                                z = true;
                                break;
                            case R2.attr.actionBarButtonIconViewStyle /* 176 */:
                                if ((i & 262144) != 262144) {
                                ...
                                z = true;
                                break;
                            case R2.attr.actionBarCopyIcon /* 178 */:
                                ...
                                z = true;
                                break;
                            case R2.attr.actionBarEmbededTabsBackground /* 186 */:
                                if ((i & 524288) != 524288) {
                                ...
                                z = true;
                                break;
                            case R2.attr.actionBarItemBackground /* 192 */:
                            ...
                            case 194:
                                ...
                                z = true;
                                break;
                            case R2.attr.actionBarUnStickIcon /* 242 */:
                                ...
                                z = true;
                                break;
                            case R2.attr.actionEndMenuButtonIconViewStyle /* 248 */:
                            ...
                            case 250:
                                ...
                                z = true;
                                break;
                            case R2.attr.actionModeAnim /* 258 */:
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (getSealedSubclassFqNameList().size() > 0) {
                codedOutputStream.writeRawVarint32(R2.array.bedtime_guide_repeat_type);
            ...
            if (getContextReceiverTypeIdList().size() > 0) {
                codedOutputStream.writeRawVarint32(R2.attr.SharedValueId);
            ...
            if (getMultiFieldValueClassUnderlyingNameList().size() > 0) {
                codedOutputStream.writeRawVarint32(R2.attr.actionBarCopyIcon);
    ...
    public static final class Property extends GeneratedMessageLite.ExtendableMessage<Property> implements PropertyOrBuilder {
        ...
        private void initFields() {
            this.flags_ = R2.attr.checkBoxOnDrawableBackgroundColor;
            this.oldFlags_ = R2.attr.shapeAppearanceCornerExtraLarge;
            this.name_ = 0;
            this.returnType_ = Type.getDefaultInstance();
            this.returnTypeId_ = 0;
            this.typeParameter_ = Collections.emptyList();
        ...
        public static final class Builder extends GeneratedMessageLite.ExtendableBuilder<Property, Builder> implements PropertyOrBuilder {
            ...
            private int returnTypeId_;
            private int setterFlags_;
            private int flags_ = R2.attr.checkBoxOnDrawableBackgroundColor;
            private int oldFlags_ = R2.attr.shapeAppearanceCornerExtraLarge;
            private Type returnType_ = Type.getDefaultInstance();
            private List<TypeParameter> typeParameter_ = Collections.emptyList();
            private Type receiverType_ = Type.getDefaultInstance();
            private List<Type> contextReceiverType_ = Collections.emptyList();
