...
public abstract class KotlinBuiltIns {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        switch (i) {
            ...
            case 108:
            case 109:
            case R2.array.countries_names_miui /* 144 */:
            case R2.array.default_card_stroke_gradient_colors_positions /* 147 */:
            case R2.array.detailed_am_pms /* 148 */:
            case R2.array.eras /* 150 */:
            case R2.array.notification_adv_time_values /* 158 */:
            case R2.array.solar_terms /* 159 */:
            case R2.array.time /* 160 */:
            case R2.array.timer_duration /* 161 */:
                objArr[0] = "descriptor";
                break;
            case 12:
            case 99:
            ...
            case 105:
            case 107:
            case R2.array.chinese_days /* 136 */:
                objArr[0] = "fqName";
                break;
            case 14:
                objArr[0] = "simpleName";
            ...
            case 127:
            case 128:
            case R2.array.auto_silence_values /* 129 */:
            case R2.array.bedtime_guide_repeat_type /* 130 */:
            case R2.array.bedtime_guide_repeat_type_international /* 131 */:
            case R2.array.bedtime_repeat_entires_international /* 132 */:
            case R2.array.bedtime_repeat_entries /* 133 */:
            case R2.array.bedtime_repeat_values /* 134 */:
            case R2.array.bedtime_repeat_values_international /* 135 */:
            case R2.array.chinese_digits /* 137 */:
            case R2.array.chinese_leap_months /* 138 */:
            case R2.array.chinese_months /* 139 */:
            case R2.array.chinese_symbol_animals /* 140 */:
            case R2.array.cities_id_miui /* 141 */:
            case R2.array.cities_names_miui /* 142 */:
            case R2.array.cities_tz_miui /* 143 */:
            case R2.array.default_card_stroke_gradient_colors_dark /* 145 */:
            case R2.array.default_card_stroke_gradient_colors_light /* 146 */:
            case R2.array.earthly_branches /* 149 */:
            case R2.array.heavenly_stems /* 151 */:
            case R2.array.months /* 152 */:
            case R2.array.months_short /* 153 */:
            case R2.array.months_shortest /* 154 */:
            case R2.array.multi_floating_package_allow_list /* 155 */:
            case R2.array.not_alarm_repeat_type_no_workdays_values /* 156 */:
            case R2.array.not_alarm_repeat_type_values /* 157 */:
            case R2.array.volume_button_setting_entries /* 163 */:
                objArr[0] = "type";
                break;
            case 47:
            ...
            case 113:
                ...
                break;
            case R2.array.timezone_search_bottom_sheet_mode_config /* 162 */:
    ...
    protected KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor contributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo1493getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (classifierDescriptorMo1491getDeclarationDescriptor == null || !UnsignedTypes.INSTANCE.isShortNameOfUnsignedArray(classifierDescriptorMo1491getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo1491getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = UnsignedTypes.INSTANCE.getUnsignedClassIdByArrayClassId(classId)) == null || (classDescriptorFindClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1491getDeclarationDescriptor = kotlinType.getConstructor().mo1491getDeclarationDescriptor();
        return (classifierDescriptorMo1491getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo1491getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo1491getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1491getDeclarationDescriptor = kotlinType.getConstructor().mo1491getDeclarationDescriptor();
        return (classifierDescriptorMo1491getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo1491getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo1491getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo1491getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    public static boolean isUByteArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.auto_silence_values);
        }
    ...
    public static boolean isUShortArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.bedtime_guide_repeat_type);
        }
    ...
    public static boolean isUIntArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.bedtime_guide_repeat_type_international);
        }
    ...
    public static boolean isULongArray(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.bedtime_repeat_entires_international);
        }
    ...
    public static boolean isUnsignedArrayType(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.bedtime_repeat_entries);
        }
    ...
    private static boolean isConstructedFromGivenClassAndNotNullable(KotlinType kotlinType, FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.bedtime_repeat_values_international);
        }
        if (fqNameUnsafe == null) {
            $$$reportNull$$$0(R2.array.chinese_days);
        }
    ...
    public static boolean isNothing(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.chinese_digits);
        }
    ...
    public static boolean isNothingOrNullableNothing(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.chinese_months);
        }
    ...
    public static boolean isAnyOrNullableAny(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.chinese_symbol_animals);
        }
    ...
    public static boolean isNullableAny(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.cities_id_miui);
        }
    ...
    public static boolean isDefaultBound(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.cities_names_miui);
        }
    ...
    public static boolean isUnit(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(R2.array.cities_tz_miui);
        }
    ...
    public static boolean isKClass(ClassDescriptor classDescriptor) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(R2.array.solar_terms);
        }
    ...
    public static boolean isDeprecated(DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(R2.array.timezone_search_bottom_sheet_mode_config);
        }
