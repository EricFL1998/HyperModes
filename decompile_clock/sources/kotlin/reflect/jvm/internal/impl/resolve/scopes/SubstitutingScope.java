...
public final class SubstitutingScope implements MemberScope {
    ...
    public void mo1497recordLookup(Name name, LookupLocation lookupLocation) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Collection _allDescriptors_delegate$lambda$1(SubstitutingScope this$0) {
    ...
    public ClassifierDescriptor mo1493getContributedClassifier(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        ClassifierDescriptor contributedClassifier = this.workerScope.mo1493getContributedClassifier(name, location);
