...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo1491getDeclarationDescriptor != null) {
            return isInlineClass(classifierDescriptorMo1491getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo1491getDeclarationDescriptor = kotlinType.getConstructor().mo1491getDeclarationDescriptor();
        if (classifierDescriptorMo1491getDeclarationDescriptor != null) {
            return isValueClass(classifierDescriptorMo1491getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo1491getDeclarationDescriptor = kotlinType.getConstructor().mo1491getDeclarationDescriptor();
        return (classifierDescriptorMo1491getDeclarationDescriptor == null || !isMultiFieldValueClass(classifierDescriptorMo1491getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
