...
public final class CapturedTypeConstructorKt {
    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt.wrapWithCapturingSubstitution.2
            ...
            public TypeProjection mo1496get(KotlinType key) {
                Intrinsics.checkNotNullParameter(key, "key");
                TypeProjection typeProjectionMo1496get = super.mo1496get(key);
                if (typeProjectionMo1496get == null) {
                    return null;
                }
                ClassifierDescriptor classifierDescriptorMo1491getDeclarationDescriptor = key.getConstructor().mo1491getDeclarationDescriptor();
                return CapturedTypeConstructorKt.createCapturedIfNeeded(typeProjectionMo1496get, classifierDescriptorMo1491getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) classifierDescriptorMo1491getDeclarationDescriptor : null);
            }
        };
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final KotlinType createCapturedIfNeeded$lambda$1(TypeProjection this_createCapturedIfNeeded) {
