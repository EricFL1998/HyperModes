...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo1491getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo1491getDeclarationDescriptor = mo1491getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo1491getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo1491getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo1491getDeclarationDescriptor = mo1491getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo1491getDeclarationDescriptor2 = typeConstructor.mo1491getDeclarationDescriptor();
        if (classifierDescriptorMo1491getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo1491getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo1491getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo1491getDeclarationDescriptor2);
        }
        return false;
    }
