...
public final class UtilsKt {
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType kotlinType : constructor2.mo1492getSupertypes()) {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (ClassifierDescriptor classifierDescriptorMo1491getDeclarationDescriptor = typeConstructor.mo1491getDeclarationDescriptor(); classifierDescriptorMo1491getDeclarationDescriptor != null; classifierDescriptorMo1491getDeclarationDescriptor = classifierDescriptorMo1491getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(classifierDescriptorMo1491getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + classifierDescriptorMo1491getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
