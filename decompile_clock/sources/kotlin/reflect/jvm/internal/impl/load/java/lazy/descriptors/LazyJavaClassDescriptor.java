...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    public static final List moduleAnnotations_delegate$lambda$2(LazyJavaClassDescriptor this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ClassId classId = DescriptorUtilsKt.getClassId(this$0);
        if (classId != null) {
            return this$0.outerContext.getComponents().getJavaModuleResolver().getAnnotationsForModuleOwnerOfClass(classId);
        }
        return null;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final LazyJavaClassMemberScope scopeHolder$lambda$3(LazyJavaClassDescriptor this$0, KotlinTypeRefiner it) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final List declaredParameters$lambda$5(LazyJavaClassDescriptor this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        List<JavaTypeParameter> typeParameters = this$0.jClass.getTypeParameters();
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(typeParameters, 10));
        for (JavaTypeParameter javaTypeParameter : typeParameters) {
            TypeParameterDescriptor typeParameterDescriptorResolveTypeParameter = this$0.c.getTypeParameterResolver().resolveTypeParameter(javaTypeParameter);
            if (typeParameterDescriptorResolveTypeParameter == null) {
                throw new AssertionError("Parameter " + javaTypeParameter + " surely belongs to class " + this$0.jClass + ", so it must be resolved");
            }
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            while (it.hasNext()) {
                ClassifierDescriptor classifierDescriptorMo1491getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType(it.next(), attributes$default).getConstructor().mo1491getDeclarationDescriptor();
    ...
    final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        protected Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (kotlinTypeEnhanceSuperType.getConstructor().mo1491getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor classDescriptorMo1491getDeclarationDescriptor = mo1491getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(classDescriptorMo1491getDeclarationDescriptor, arrayList5);
            }
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor annotationDescriptorMo1486findAnnotation = annotations.mo1486findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
            if (annotationDescriptorMo1486findAnnotation == null) {
                return null;
            }
            Object objSingleOrNull = CollectionsKt.singleOrNull(annotationDescriptorMo1486findAnnotation.getAllValueArguments().values());
        ...
        public ClassDescriptor mo1491getDeclarationDescriptor() {
