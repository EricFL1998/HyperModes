...
public final class KTypeImpl implements KTypeBase {
    ...
    private final KClassifier convert(KotlinType type) {
        ...
        if (classifierDescriptorMo1491getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return new KTypeParameterImpl(null, (TypeParameterDescriptor) classifierDescriptorMo1491getDeclarationDescriptor);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final List arguments_delegate$lambda$5(final KTypeImpl this$0, Function0 function0) {
        KTypeProjection kTypeProjectionInvariant;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        List<TypeProjection> arguments = this$0.type.getArguments();
        if (arguments.isEmpty()) {
            return CollectionsKt.emptyList();
        }
        final Lazy lazy = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, new Function0(this$0) { // from class: kotlin.reflect.jvm.internal.KTypeImpl$$Lambda$2
            private final KTypeImpl arg$0;
        ...
        for (Object obj : list) {
            ...
            if (typeProjection.isStarProjection()) {
                ...
                KTypeImpl kTypeImpl = new KTypeImpl(type, function0 == null ? null : new Function0(this$0, i, lazy) { // from class: kotlin.reflect.jvm.internal.KTypeImpl$$Lambda$3
                    private final KTypeImpl arg$0;
