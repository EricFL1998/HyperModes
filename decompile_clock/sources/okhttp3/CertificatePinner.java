...
public final class CertificatePinner {
    ...
    public void check(String str, List<Certificate> list) throws SSLPeerUnverifiedException {
        ...
        sb.append("\n  Pinned certificates for ").append(str).append(MethodCodeHelper.IDENTITY_INFO_SEPARATOR);
    ...
    static final class Pin {
        ...
        public int hashCode() {
            return ((((R2.attr.checkWidgetOnAlphaDrawableBackgroundColor + this.pattern.hashCode()) * 31) + this.hashAlgorithm.hashCode()) * 31) + this.hash.hashCode();
        }
