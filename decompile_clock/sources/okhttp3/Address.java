...
public final class Address {
    ...
    public int hashCode() {
        int iHashCode = (((((((((((R2.attr.checkWidgetOnAlphaDrawableBackgroundColor + this.url.hashCode()) * 31) + this.dns.hashCode()) * 31) + this.proxyAuthenticator.hashCode()) * 31) + this.protocols.hashCode()) * 31) + this.connectionSpecs.hashCode()) * 31) + this.proxySelector.hashCode()) * 31;
    ...
    public String toString() {
        StringBuilder sbAppend = new StringBuilder("Address{").append(this.url.host()).append(MethodCodeHelper.IDENTITY_INFO_SEPARATOR).append(this.url.port());
        if (this.proxy != null) {
