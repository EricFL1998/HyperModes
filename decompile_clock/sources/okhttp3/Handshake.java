...
public final class Handshake {
    ...
    public int hashCode() {
        return ((((((R2.attr.checkWidgetOnAlphaDrawableBackgroundColor + this.tlsVersion.hashCode()) * 31) + this.cipherSuite.hashCode()) * 31) + this.peerCertificates.hashCode()) * 31) + this.localCertificates.hashCode();
    }
}
