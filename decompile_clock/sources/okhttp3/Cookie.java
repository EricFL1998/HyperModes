...
public final class Cookie {
  ...
  0x00c0: PHI (r0v16 long) = (r0v2 long), (r0v6 long) binds: [B:42:0x00be, B:53:0x00e1] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    static Cookie parse(long j, HttpUrl httpUrl, String str) {
        ...
        while (i < length) {
            ...
            if (strTrimSubstring4.equalsIgnoreCase("expires")) {
                ...
                z4 = false;
            } else if (strTrimSubstring4.equalsIgnoreCase(g.G)) {
    ...
    private static long parseExpires(String str, int i, int i2) {
        ...
        if (i3 >= 70 && i3 <= 99) {
            i3 += R2.attr.preferenceItemPaddingTop;
        }
        if (i3 >= 0 && i3 <= 69) {
            i3 += 2000;
        }
    ...
    public int hashCode() {
        int iHashCode = (((((((R2.attr.checkWidgetOnAlphaDrawableBackgroundColor + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31;
