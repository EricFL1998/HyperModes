...
public final class ConnectionSpec {
    ...
    static {
        ...
        ConnectionSpec connectionSpecBuild = new Builder(true).cipherSuites(cipherSuiteArr2).tlsVersions(TlsVersion.TLS_1_2, TlsVersion.TLS_1_1, TlsVersion.TLS_1_0).supportsTlsExtensions(true).build();
    ...
    public int hashCode() {
        if (this.tls) {
            return ((((R2.attr.checkWidgetOnAlphaDrawableBackgroundColor + Arrays.hashCode(this.cipherSuites)) * 31) + Arrays.hashCode(this.tlsVersions)) * 31) + (!this.supportsTlsExtensions ? 1 : 0);
        }
        return 17;
    }
