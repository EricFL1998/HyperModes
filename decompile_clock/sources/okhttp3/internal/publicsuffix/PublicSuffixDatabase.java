...
public final class PublicSuffixDatabase {
    ...
    public String getEffectiveTldPlusOne(String str) {
        ...
        String[] strArrSplit = IDN.toUnicode(str).split(z.a);
        ...
        String[] strArrSplit2 = str.split(z.a);
    ...
    private String[] findMatchingRule(String[] strArr) {
        ...
        if (str != null) {
            return (AlphabetIndexer.STARRED_TITLE + str).split(z.a);
        }
        if (strBinarySearchBytes == null && strBinarySearchBytes2 == null) {
            return PREVAILING_RULE;
        }
        if (strBinarySearchBytes != null) {
            strArrSplit = strBinarySearchBytes.split(z.a);
        } else {
            strArrSplit = EMPTY_RULE;
        }
        if (strBinarySearchBytes2 != null) {
            strArrSplit2 = strBinarySearchBytes2.split(z.a);
        } else {
