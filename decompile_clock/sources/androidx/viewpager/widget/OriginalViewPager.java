...
public class OriginalViewPager extends ViewGroup {
    ...
    int convertPositionForRTL(int i, int i2, boolean z, boolean z2) {
        return z == z2 ? i2 : (i - i2) - 1;
    }
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() { // from class: androidx.viewpager.widget.OriginalViewPager.4
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                ...
                for (int i = 0; i < childCount; i++) {
                    WindowInsetsCompat windowInsetsCompatDispatchApplyWindowInsets = ViewCompat.dispatchApplyWindowInsets(OriginalViewPager.this.getChildAt(i), windowInsetsCompatOnApplyWindowInsets);
    ...
    public void setOffscreenPageLimit(int i) {
        if (i < 2) {
            Log.w(TAG, "Requested offscreen page limit " + i + " too small; defaulting to 2");
            i = 2;
        }
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        SpringScroller springScroller2 = this.mScroller;
        if (springScroller2 != null) {
            springScroller2.startScroll(scrollX, i, scrollY, i2, -i3);
        }
  ...
  0x00fb: PHI (r15v7 float) = (r15v5 float), (r15v6 float), (r15v4 float) binds: [B:63:0x00f0, B:60:0x00da, B:54:0x00c4] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (i != -1 && (iFindPointerIndex = motionEvent.findPointerIndex(i)) >= 0 && iFindPointerIndex < motionEvent.getPointerCount()) {
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            if (accessibilityEvent.getEventType() != 4096 || OriginalViewPager.this.mAdapter == null) {
                return;
            }
            accessibilityEvent.setItemCount(OriginalViewPager.this.mAdapter.getCount());
        ...
        public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            ...
            if (i != 8192 || !OriginalViewPager.this.canScrollHorizontally(-1)) {
                return false;
            }
        ...
        private boolean canScroll() {
            return OriginalViewPager.this.mAdapter != null && OriginalViewPager.this.mAdapter.getCount() > 1;
        }
    }
