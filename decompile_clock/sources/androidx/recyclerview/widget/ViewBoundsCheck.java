...
class ViewBoundsCheck {
    ...
    static class BoundFlags {
        ...
        boolean boundsMatch() {
            ...
            if ((i3 & R2.attr.original_height) != 0 && (i3 & (compare(this.mChildEnd, this.mRvStart) << 8)) == 0) {
                return false;
            }
            int i4 = this.mBoundFlags;
            return (i4 & DateUtils.FORMAT_ABBREV_ALL) == 0 || (i4 & (compare(this.mChildEnd, this.mRvEnd) << 12)) != 0;
        }
    }
