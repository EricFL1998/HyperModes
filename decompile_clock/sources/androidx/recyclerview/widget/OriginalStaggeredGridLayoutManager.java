...
public class OriginalStaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new Runnable() { // from class: androidx.recyclerview.widget.OriginalStaggeredGridLayoutManager.1
        @Override // java.lang.Runnable
        public void run() {
            OriginalStaggeredGridLayoutManager.this.checkForGaps();
        }
    };
    ...
    /* JADX WARN: Type inference failed for: r16v0, types: [androidx.recyclerview.widget.OriginalStaggeredGridLayoutManager] */
    ...
    class Span {
        ...
        void calculateCachedStart() {
            ...
            this.mCachedStart = OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getDecoratedStart(view);
            if (layoutParams.mFullSpan && (fullSpanItem = OriginalStaggeredGridLayoutManager.this.mLazySpanLookup.getFullSpanItem(layoutParams.getViewLayoutPosition())) != null && fullSpanItem.mGapDir == -1) {
        ...
        void calculateCachedEnd() {
            ...
            LayoutParams layoutParams = getLayoutParams(view);
            this.mCachedEnd = OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getDecoratedEnd(view);
            if (layoutParams.mFullSpan && (fullSpanItem = OriginalStaggeredGridLayoutManager.this.mLazySpanLookup.getFullSpanItem(layoutParams.getViewLayoutPosition())) != null && fullSpanItem.mGapDir == 1) {
        ...
        void prependToSpan(View view) {
            ...
            if (layoutParams.isItemRemoved() || layoutParams.isItemChanged()) {
                this.mDeletedSize += OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getDecoratedMeasurement(view);
            }
        }
        ...
        void cacheReferenceLineAndClear(boolean z, int i) {
            ...
            if (!z || startLine >= OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getEndAfterPadding()) {
                if (z || startLine <= OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getStartAfterPadding()) {
                    if (i != Integer.MIN_VALUE) {
                        startLine += i;
                    }
        ...
        void popEnd() {
            ...
            if (layoutParams.isItemRemoved() || layoutParams.isItemChanged()) {
                this.mDeletedSize -= OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getDecoratedMeasurement(viewRemove);
            }
            if (size == 1) {
                this.mCachedStart = Integer.MIN_VALUE;
            }
        ...
        public int findFirstVisibleItemPosition() {
            if (OriginalStaggeredGridLayoutManager.this.mReverseLayout) {
        ...
        int findOnePartiallyOrCompletelyVisibleChild(int i, int i2, boolean z, boolean z2, boolean z3) {
            int startAfterPadding = OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getStartAfterPadding();
            int endAfterPadding = OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getEndAfterPadding();
            int i3 = i2 > i ? 1 : -1;
            while (i != i2) {
                View view = this.mViews.get(i);
                int decoratedStart = OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getDecoratedStart(view);
                int decoratedEnd = OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getDecoratedEnd(view);
                boolean z4 = false;
        ...
        public View getFocusableViewAfter(int i, int i2) {
            ...
            if (i2 == -1) {
                ...
                while (i3 < size) {
                    ...
                    if ((OriginalStaggeredGridLayoutManager.this.mReverseLayout && OriginalStaggeredGridLayoutManager.this.getPosition(view2) <= i) || ((!OriginalStaggeredGridLayoutManager.this.mReverseLayout && OriginalStaggeredGridLayoutManager.this.getPosition(view2) >= i) || !view2.hasFocusable())) {
                        break;
                    }
                    i3++;
                    view = view2;
                ...
                while (size2 >= 0) {
                    ...
                    if ((OriginalStaggeredGridLayoutManager.this.mReverseLayout && OriginalStaggeredGridLayoutManager.this.getPosition(view3) >= i) || ((!OriginalStaggeredGridLayoutManager.this.mReverseLayout && OriginalStaggeredGridLayoutManager.this.getPosition(view3) <= i) || !view3.hasFocusable())) {
                        break;
                    }
                    size2--;
                    view = view3;
    ...
    class AnchorInfo {
        ...
        void saveSpanReferenceLines(Span[] spanArr) {
            ...
            if (iArr == null || iArr.length < length) {
                this.mSpanReferenceLines = new int[OriginalStaggeredGridLayoutManager.this.mSpans.length];
            }
        ...
        void assignCoordinateFromPadding() {
            this.mOffset = this.mLayoutFromEnd ? OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getEndAfterPadding() : OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getStartAfterPadding();
        }

        void assignCoordinateFromPadding(int i) {
            if (this.mLayoutFromEnd) {
                this.mOffset = OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getEndAfterPadding() - i;
            } else {
                this.mOffset = OriginalStaggeredGridLayoutManager.this.mPrimaryOrientation.getStartAfterPadding() + i;
            }
        }
    }
}
