...
public class DependencyNode implements Dependency {
    ...
    public String toString() {
        return this.run.widget.getDebugName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + this.type + "(" + (this.resolved ? Integer.valueOf(this.value) : "unresolved") + ") <t=" + this.targets.size() + ":d=" + this.dependencies.size() + ">";
    }
    ...
    public String name() {
        ...
        return str + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + this.type.name();
    }
