...
public class WidgetFrame {
    ...
    void printCustomAttributes() {
        ...
        String str2 = (".(" + stackTraceElement.getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + " " + (hashCode() % 1000);
        if (this.widget != null) {
