...
public class SpringStopEngine implements StopEngine {
    ...
    void log(String str) {
        ...
        System.out.println((".(" + stackTraceElement.getFileName() + MethodCodeHelper.IDENTITY_INFO_SEPARATOR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName() + "() ") + str);
    }
