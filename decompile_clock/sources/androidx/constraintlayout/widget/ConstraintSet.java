...
public class ConstraintSet {
        ...
        if (value != null) {
            ...
            if (iIndexOf > 0 && iIndexOf < length - 1) {
                ...
                if (strSubstring.equalsIgnoreCase("W")) {
                    i = 0;
                } else if (strSubstring.equalsIgnoreCase(h.b)) {
                    i = 1;
                }
                i2 = iIndexOf + 1;
            }
    ...
    public void parseIntAttributes(Constraint set, String attributes) {
        String[] strArrSplit = attributes.split(z.b);
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        String[] strArrSplit = referenceIdString.split(z.b);
    ...
    class WriteXmlEngine {
        ...
        void writeVariable(String name, int[] value) throws IOException {
            ...
            this.writer.write(SPACE + name);
            this.writer.write(MethodCodeHelper.IDENTITY_INFO_SEPARATOR);
            int i = 0;
