    ...
    private static void encodeUtf8Buffer(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            if (cCharAt2 < 128) {
                ...
                int i2 = iPosition + 1;
                try {
                    byteBuffer.put(iPosition, (byte) ((cCharAt2 >>> 6) | R2.attr.actionBarItemBackground));
                ...
                int i3 = iPosition + 1;
                byteBuffer.put(iPosition, (byte) ((cCharAt2 >>> '\f') | R2.attr.actionBarStyle));
                iPosition += 2;
                ...
                if (i4 != length) {
                    try {
                        ...
                        if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                            ...
                            int i5 = iPosition + 1;
                            try {
                                byteBuffer.put(iPosition, (byte) ((codePoint >>> 18) | R2.attr.actionBarTitleColor));
                                int i6 = iPosition + 2;
                                try {
                ...
                if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i7 > i5 - 3) {
                    if (i7 <= i5 - 4) {
                        ...
                        if (i9 != charSequence.length()) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                bArr[i7] = (byte) ((codePoint >>> 18) | R2.attr.actionBarTitleColor);
