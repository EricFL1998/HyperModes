...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    Parcelable saveAllState() {
        ...
        Bundle bundleM49lambda$attachController$4$androidxfragmentappFragmentManager = m49lambda$attachController$4$androidxfragmentappFragmentManager();
        if (bundleM49lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
            return null;
        }
        return bundleM49lambda$attachController$4$androidxfragmentappFragmentManager;
    }
    ...
    void attachController(FragmentHostCallback<?> fragmentHostCallback, FragmentContainer fragmentContainer, final Fragment fragment) {
        ...
        if (obj2 instanceof ActivityResultRegistryOwner) {
            ...
            String str = "FragmentManager:" + (fragment != null ? fragment.mWho + MethodCodeHelper.IDENTITY_INFO_SEPARATOR : "");
