...
import com.android.deskclock.addition.resource.ResourceRepository;
...
class ProfileTranscoder {
    ...
    private static String generateDexKey(String str, String str2, byte[] bArr) {
        ...
        return str2.endsWith(ResourceRepository.MODULE_FILE_EXTENSION) ? str2 : str + ProfileVersion.dexKeySeparator(bArr) + str2;
    }

    private static String enforceSeparator(String str, String str2) {
        if (AlphabetIndexer.STARRED_TITLE.equals(str2)) {
            return str.replace(MethodCodeHelper.IDENTITY_INFO_SEPARATOR, AlphabetIndexer.STARRED_TITLE);
        }
        return MethodCodeHelper.IDENTITY_INFO_SEPARATOR.equals(str2) ? str.replace(AlphabetIndexer.STARRED_TITLE, MethodCodeHelper.IDENTITY_INFO_SEPARATOR) : str;
    }
