...
final class StartedWhileSubscribed implements SharingStarted {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.StartedWhileSubscribed$command$1", f = "SharingStarted.kt", i = {1, 2, 3}, l = {R2.attr.actionBarCopyIcon, 180, R2.attr.actionBarDivider, R2.attr.actionBarEditIcon, R2.attr.actionBarEmbedTabs}, m = "invokeSuspend", n = {"$this$transformLatest", "$this$transformLatest", "$this$transformLatest"}, s = {"L$0", "L$0", "L$0"})
