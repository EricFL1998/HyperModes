...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1", f = "Share.kt", i = {}, l = {R2.attr.actionBarShareIcon, R2.attr.actionBarSplitStyle, R2.attr.actionBarStackBackground, R2.attr.actionBarSubtitleColor}, m = "invokeSuspend", n = {}, s = {})
final class FlowKt__ShareKt$launchSharing$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$2", f = "Share.kt", i = {}, l = {R2.attr.actionBarTabActivatedTextSecondaryStyle}, m = "invokeSuspend", n = {}, s = {})
