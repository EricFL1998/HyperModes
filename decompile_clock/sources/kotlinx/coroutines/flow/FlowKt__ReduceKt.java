...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0, 0}, l = {R2.attr.actionBarEditIcon}, m = "first", n = {"predicate", g.L, "collector$iv"}, s = {"L$0", "L$1", "L$2"})
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {R2.attr.actionBarEditIcon}, m = "firstOrNull", n = {g.L, "collector$iv"}, s = {"L$0", "L$1"})
    static final class C01361<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {R2.attr.actionBarEditIcon}, m = "firstOrNull", n = {g.L, "collector$iv"}, s = {"L$0", "L$1"})
    static final class C01373<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C01373(Continuation<? super C01373> continuation) {
            super(continuation);
        }
    ...
    static final class C01381<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0}, l = {R2.array.multi_floating_package_allow_list}, m = "last", n = {g.L}, s = {"L$0"})
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0}, l = {R2.attr.DigitalClockStyle}, m = "lastOrNull", n = {g.L}, s = {"L$0"})
    static final class C01411<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C01431<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0}, l = {57}, m = "single", n = {g.L}, s = {"L$0"})
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {R2.attr.actionBarEditIcon}, m = "singleOrNull", n = {g.L, "collector$iv"}, s = {"L$0", "L$1"})
    ...
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Object> c01442 = new C01442<>(objectRef2, function3);
            c01431.L$0 = objectRef2;
            c01431.label = 1;
            if (flow.collect(c01442, c01431) == coroutine_suspended) {
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\b\b\u0001\u0010\u0003*\u0002H\u00022\u0006\u0010\u0004\u001a\u0002H\u0003H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"<anonymous>", "", "S", "T", g.p, "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, k = 3, mv = {1, 6, 0}, xi = 48)
    static final class C01442<T> implements FlowCollector {
        final /* synthetic */ Ref.ObjectRef<Object> $accumulator;
        final /* synthetic */ Function3<S, T, Continuation<? super S>, Object> $operation;

        /* JADX WARN: Multi-variable type inference failed */
        C01442(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
    ...
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c01381.L$0 = objectRef2;
            c01381.label = 1;
            if (flow.collect(anonymousClass2, c01381) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01381.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
    ...
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                ...
                c01471.L$1 = flowCollector2;
                c01471.label = 1;
                if (flow.collect(flowCollector2, c01471) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            ...
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c01471.L$1;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                c01361.L$0 = objectRef2;
                c01361.L$1 = flowCollector2;
                c01361.label = 1;
                if (flow.collect(flowCollector2, c01361) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c01361.L$1;
            objectRef = (Ref.ObjectRef) c01361.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C01373) {
            c01373 = (C01373) continuation;
            if ((c01373.label & Integer.MIN_VALUE) != 0) {
                c01373.label -= Integer.MIN_VALUE;
            } else {
                c01373 = new C01373(continuation);
            }
        } else {
            c01373 = new C01373(continuation);
        }
        Object obj = c01373.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c01373.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c01373.L$0 = objectRef2;
                c01373.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c01373.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c01373) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c01373.L$1;
            objectRef = (Ref.ObjectRef) c01373.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object last(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c01391.L$0 = objectRef2;
            c01391.label = 1;
            if (flow.collect(flowCollector, c01391) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01391.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
            throw new NoSuchElementException("Expected at least one element");
    ...
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c01411.L$0 = objectRef2;
            c01411.label = 1;
            if (flow.collect(flowCollector, c01411) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01411.L$0;
            ResultKt.throwOnFailure(obj);
        }
        return objectRef.element;
    }
