...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt", f = "Errors.kt", i = {0}, l = {R2.array.not_alarm_repeat_type_no_workdays_values}, m = "catchImpl", n = {"fromDownstream"}, s = {"L$0"})
    ...
    static final class C01311 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01311(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C01311) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
