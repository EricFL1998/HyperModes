...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1763scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1763scheduleResumeAfterDelay(timeMillis, continuation);
    }
                ...
                if (runnableRemoveFirstOrNull != null) {
                    ...
                    if (i >= 16) {
                        ...
                        if (this.dispatcher.isDispatchNeeded(limitedDispatcher)) {
                            this.dispatcher.mo1762dispatch(limitedDispatcher, this);
                            return;
                        }
                    }
                }
    ...
    public void mo1762dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo1762dispatch(this, this);
    }
