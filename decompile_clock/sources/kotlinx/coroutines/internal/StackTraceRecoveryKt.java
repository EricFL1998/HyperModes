...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM204constructorimpl = Result.m204constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM204constructorimpl = Result.m204constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m207exceptionOrNullimpl(objM204constructorimpl) == null) {
            obj2 = objM204constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM204constructorimpl2 = Result.m204constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM204constructorimpl2 = Result.m204constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m207exceptionOrNullimpl(objM204constructorimpl2) == null) {
            obj = objM204constructorimpl2;
        }
