...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM204constructorimpl = Result.m204constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM204constructorimpl;
        }
                ...
                public final Throwable invoke(Throwable th) {
                    ...
                    try {
                        ...
                        if (objNewInstance != null) {
                            ...
                            th2.initCause(th);
                            objM204constructorimpl = Result.m204constructorimpl(th2);
                            if (Result.m210isFailureimpl(objM204constructorimpl)) {
                                objM204constructorimpl = null;
                            }
                            return (Throwable) objM204constructorimpl;
                        }
                        throw new NullPointerException("null cannot be cast to non-null type kotlin.Throwable");
                    } catch (Throwable th3) {
                        Result.Companion companion2 = Result.INSTANCE;
                        objM204constructorimpl = Result.m204constructorimpl(ResultKt.createFailure(th3));
                    }
                }
            };
        }
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        try {
                            ...
                            if (objNewInstance != null) {
                                objM204constructorimpl = Result.m204constructorimpl((Throwable) objNewInstance);
                                if (Result.m210isFailureimpl(objM204constructorimpl)) {
                                    objM204constructorimpl = null;
                                }
                                return (Throwable) objM204constructorimpl;
                            ...
                            Result.Companion companion2 = Result.INSTANCE;
                            objM204constructorimpl = Result.m204constructorimpl(ResultKt.createFailure(th2));
                        }
                    }
                };
            }
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM204constructorimpl = Result.m204constructorimpl(function2.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM204constructorimpl = Result.m204constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM204constructorimpl = Result.m204constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM204constructorimpl = Result.m204constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m210isFailureimpl(objM204constructorimpl)) {
            objM204constructorimpl = numValueOf;
        }
        return ((Number) objM204constructorimpl).intValue();
    }
