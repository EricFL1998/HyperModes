...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            return ChannelResult.m1721boximpl(Result.m211isSuccessimpl(objM204constructorimpl) ? ChannelResult.INSTANCE.m1736successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1734closedJP2dKIU(Result.m207exceptionOrNullimpl(objM204constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1716trySendJP2dKIU = sendChannel.mo1716trySendJP2dKIU(e);
        if (objMo1716trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1731isSuccessimpl(sendChannel.mo1716trySendJP2dKIU(e))) {
            return;
        }
