...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final Object mo1714receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        ...
        if (i == 0) {
            ...
            if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                return objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m1734closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m1736successJP2dKIU(objPollInternal);
            }
    ...
    public final Object mo1715tryReceivePtdJZtk() {
        Object objPollInternal = pollInternal();
        if (objPollInternal == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.INSTANCE.m1735failurePtdJZtk();
        }
        return objPollInternal instanceof Closed ? ChannelResult.INSTANCE.m1734closedJP2dKIU(((Closed) objPollInternal).closeCause) : ChannelResult.INSTANCE.m1736successJP2dKIU(objPollInternal);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object objM1753constructorimpl$default = InlineList.m1753constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo1761remove()) {
                    prevNode.helpRemove();
                } else {
                    objM1753constructorimpl$default = InlineList.m1758plusFjFbRPM(objM1753constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1713onCancelIdempotentListww6eGU(objM1753constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) throws Throwable {
        ...
        if (!z) {
            if (i != 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1721boximpl(z ? companion.m1734closedJP2dKIU(((Closed) obj).closeCause) : companion.m1736successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1721boximpl(ChannelResult.INSTANCE.m1734closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
            ...
            while (true) {
                ...
                if (objPollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m204constructorimpl(Boxing.boxBoolean(false)));
                        break;
                    }
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuationImpl.resumeWith(Result.m204constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    break;
                }
                if (objPollInternal != AbstractChannelKt.POLL_FAILED) {
                    Boolean boolBoxBoolean = Boxing.boxBoolean(true);
                    Function1<E, Unit> function1 = this.channel.onUndeliveredElement;
                    cancellableContinuationImpl.resume(boolBoxBoolean, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, objPollInternal, cancellableContinuationImpl.get$context()) : null);
                    break;
                }
            }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1721boximpl(ChannelResult.INSTANCE.m1736successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m204constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
            } else {
                CancellableContinuation<Object> cancellableContinuation2 = this.cont;
                ChannelResult channelResultM1721boximpl = ChannelResult.m1721boximpl(ChannelResult.INSTANCE.m1734closedJP2dKIU(closed.closeCause));
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m204constructorimpl(channelResultM1721boximpl));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) throws Throwable {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1721boximpl(ChannelResult.INSTANCE.m1736successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) throws Throwable {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1721boximpl(ChannelResult.INSTANCE.m1734closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo1713onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
