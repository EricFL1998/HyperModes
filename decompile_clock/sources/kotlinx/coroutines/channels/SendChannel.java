...
public interface SendChannel<E> {
    ...
    Object mo1716trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1731isSuccessimpl(objMo1716trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1725exceptionOrNullimpl = ChannelResult.m1725exceptionOrNullimpl(objMo1716trySendJP2dKIU);
