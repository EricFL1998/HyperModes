...
public interface ReceiveChannel<E> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.channels.ReceiveChannel$DefaultImpls", f = "Channel.kt", i = {}, l = {R2.attr.backgroundOverlayColorAlpha}, m = "receiveOrNull", n = {}, s = {})
    ...
    Object mo1714receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1715tryReceivePtdJZtk = receiveChannel.mo1715tryReceivePtdJZtk();
            if (ChannelResult.m1731isSuccessimpl(objMo1715tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1727getOrThrowimpl(objMo1715tryReceivePtdJZtk);
            }
            Throwable thM1725exceptionOrNullimpl = ChannelResult.m1725exceptionOrNullimpl(objMo1715tryReceivePtdJZtk);
            if (thM1725exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1725exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo1714receiveCatchingJP2dKIU = receiveChannel.mo1714receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m1726getOrNullimpl(objMo1714receiveCatchingJP2dKIU);
        }
