...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object mo1716trySendJP2dKIU(E element) {
        Object objOfferInternal = offerInternal(element);
        if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m1736successJP2dKIU(Unit.INSTANCE);
        }
        if (objOfferInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m1735failurePtdJZtk() : ChannelResult.INSTANCE.m1734closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m1734closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m204constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m204constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo1761remove()) {
                receive.helpRemove();
            } else {
                objM1753constructorimpl$default = InlineList.m1758plusFjFbRPM(objM1753constructorimpl$default, receive);
            }
        }
        if (objM1753constructorimpl$default != null) {
            if (!(objM1753constructorimpl$default instanceof ArrayList)) {
                ((Receive) objM1753constructorimpl$default).resumeReceiveClosed(closed);
            } else if (objM1753constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) objM1753constructorimpl$default;
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            if (isFullImpl()) {
                ...
                if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuationImpl.resumeWith(Result.m204constructorimpl(Unit.INSTANCE));
                    break;
                }
                if (objOfferInternal != AbstractChannelKt.OFFER_FAILED) {
                    if (objOfferInternal instanceof Closed) {
