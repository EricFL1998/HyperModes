...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        ...
        Object objM204constructorimpl2;
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m204constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m204constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m204constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(objTakeState$kotlinx_coroutines_core)));
                }
                ...
                try {
                    ...
                    objM204constructorimpl2 = Result.m204constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    objM204constructorimpl2 = Result.m204constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m207exceptionOrNullimpl(objM204constructorimpl2));
            } catch (Throwable th2) {
                if (undispatchedCoroutineUpdateUndispatchedCompletion == null || undispatchedCoroutineUpdateUndispatchedCompletion.clearThreadContext()) {
                    ThreadContextKt.restoreThreadContext(context, objUpdateThreadContext);
                }
            ...
            try {
                ...
                taskContext.afterTask();
                objM204constructorimpl = Result.m204constructorimpl(Unit.INSTANCE);
            } catch (Throwable th4) {
                Result.Companion companion7 = Result.INSTANCE;
                objM204constructorimpl = Result.m204constructorimpl(ResultKt.createFailure(th4));
            }
            handleFatalException(th3, Result.m207exceptionOrNullimpl(objM204constructorimpl));
        }
    }
