...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM204constructorimpl = Result.m204constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM204constructorimpl = Result.m204constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m210isFailureimpl(objM204constructorimpl) ? null : objM204constructorimpl);
    ...
    public static final void m1739installSignalHandler$lambda1(Signal signal) {
