...
public final class DelayKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.DelayKt", f = "Delay.kt", i = {}, l = {R2.array.detailed_am_pms}, m = "awaitCancellation", n = {}, s = {})
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.get$context()).mo1763scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m1700delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1701toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1701toDelayMillisLRDsOJo(long j) {
        if (Duration.m1563compareToLRDsOJo(j, Duration.INSTANCE.m1655getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1575getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
