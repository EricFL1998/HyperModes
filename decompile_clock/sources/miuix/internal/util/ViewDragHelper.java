...
public class ViewDragHelper {
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            View viewFindTopChildUnder3 = findTopChildUnder((int) x, (int) y);
            if (viewFindTopChildUnder3 == this.mCapturedView && this.mDragState == 2) {
                tryCaptureViewForDrag(viewFindTopChildUnder3, pointerId);
            }
            ...
            for (int i3 = 0; i3 < pointerCount; i3++) {
                ...
                if (isValidPointerForActionMove(pointerId2)) {
                    ...
                    if (this.mDragState == 1 || ((viewFindTopChildUnder = findTopChildUnder((int) x2, (int) y2)) != null && checkTouchSlop(viewFindTopChildUnder, f, f2) && tryCaptureViewForDrag(viewFindTopChildUnder, pointerId2))) {
                        break;
                    }
                }
            }
            ...
            } else if (i4 == 2 && (viewFindTopChildUnder2 = findTopChildUnder((int) x3, (int) y3)) == this.mCapturedView) {
                tryCaptureViewForDrag(viewFindTopChildUnder2, pointerId3);
            }
    ...
    /* JADX WARN: Type inference failed for: r3v3, types: [miuix.internal.util.ViewDragHelper$Callback] */
    ...
    private boolean checkTouchSlop(View view, float f, float f2) {
        ...
        if (z) {
            return Math.abs(f2) < ((float) this.mTouchSlop) && Math.abs(f) > ((float) this.mTouchSlop);
        }
        return z2 && Math.abs(f) < ((float) this.mTouchSlop) && Math.abs(f2) > ((float) this.mTouchSlop);
    }
