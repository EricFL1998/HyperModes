...
import miuix.view.HapticFeedback;
import miuix.view.HapticFeedbackConstants;

/* JADX INFO: loaded from: classes2.dex */
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView, NestedContentInsetObserver, HapticFeedback {
    ...
    private boolean mMiuixHapticFeedbackEnabled;
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mMiuixHapticFeedbackEnabled = true;
        initScrollView();
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = R2.array.bedtime_guide_repeat_type;
        if (!zCanScroll) {
            ...
            View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, R2.array.bedtime_guide_repeat_type);
            return (viewFindNextFocus == null || viewFindNextFocus == this || !viewFindNextFocus.requestFocus(R2.array.bedtime_guide_repeat_type)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (!keyEvent.isAltPressed()) {
                return arrowScroll(R2.array.bedtime_guide_repeat_type);
            }
            return fullScroll(R2.array.bedtime_guide_repeat_type);
        }
        if (keyCode != 62) {
            return false;
        }
    ...
    public void computeScroll() {
        ...
        stopNestedScroll(1);
        if (this.mHasReachEdgeBeforeFling || !this.mMiuixHapticFeedbackEnabled) {
            return;
        }
        if (HapticCompat.doesSupportHaptic(HapticCompat.HapticVersion.HAPTIC_VERSION_2)) {
            getHapticFeedbackCompat().m1943x85658b2f(201);
        } else {
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = R2.array.bedtime_guide_repeat_type;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        View viewFindFocus = findFocus();
        if (viewFindFocus == null || this == viewFindFocus || !isViewDescendantOf(viewFindFocus, this) || !isWithinDeltaOfScreen(viewFindFocus, 0, i4)) {
            return;
        }
    ...
    @Override // miuix.view.HapticFeedback
    public void setMiuixHapticFeedbackEnabled(boolean z) {
        this.mMiuixHapticFeedbackEnabled = z;
    }

    @Override // miuix.view.HapticFeedback
    public boolean isMiuixHapticFeedbackEnabled() {
        return this.mMiuixHapticFeedbackEnabled;
    }
