...
public class NotificationTemplate extends AbstractMarkTemplate {
    ...
    static {
        ...
        sparseArray.put(R.id.area_head, generateLayoutParams(1, 0.0f, 0.0f, 48, 0).setMargin(0, 0, 16, 0));
        sparseArray.put(R.id.view_auxiliary, generateLayoutParams(2, 0.0f, 1.0f, 0, 1));
        ...
        sparseArray.put(R.id.view_auxiliary2, generateLayoutParams(3, 1.0f, 0.0f, 0, 4));
        sparseArray.put(R.id.area_comment, generateLayoutParams(3, 0.0f, 0.0f, 16, 5).setMargin(8, 0, 0, 0).setPriority(1));
        sparseArray.put(R.id.area_content, generateLayoutParams(2, 0.0f, 0.0f, 0, 6).setMargin(0, 10, 0, 0));
        sparseArray.put(R.id.area_end, generateLayoutParams(1, 0.0f, 0.0f, 17, 7).setMargin(10, 0, 0, 0));
        ...
        sparseArray2.put(R.id.area_head, generateLayoutParams(3, 0.0f, 0.0f, 16, 1).setMargin(0, 0, 16, 0));
        sparseArray2.put(R.id.area_title, generateLayoutParams(3, 0.0f, 0.0f, 16, 2).setMargin(0, 0, 0, 0));
        sparseArray2.put(R.id.area_title_comment, generateLayoutParams(2, 0.0f, 0.0f, 16, 3).setMargin(0, 4, 0, 0).setPriority(1));
        sparseArray2.put(R.id.view_auxiliary2, generateLayoutParams(2, 0.0f, 0.0f, 0, 4));
        sparseArray2.put(R.id.area_content, generateLayoutParams(2, 0.0f, 0.0f, 0, 5).setMargin(0, 10, 0, 0));
        sparseArray2.put(R.id.area_comment, generateLayoutParams(2, 0.0f, 0.0f, 0, 6).setMargin(0, 4, 0, 0).setPriority(1));
        sparseArray2.put(R.id.area_end, generateLayoutParams(1, 0.0f, 0.0f, 17, 7).setMargin(10, 0, 0, 0));
    }
    ...
    public void onAddAuxiliaryViews(ViewGroup viewGroup) {
        ...
        addAuxiliaryView(viewGroup, this.mContext, R.id.view_auxiliary, -1, 0);
        addAuxiliaryView(viewGroup, this.mContext, R.id.view_auxiliary2, -1, 0);
    }
