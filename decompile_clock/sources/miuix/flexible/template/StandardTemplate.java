...
public class StandardTemplate extends AbstractMarkTemplate {
    ...
    static {
        ...
        sparseArray.put(R.id.area_end, generateLayoutParams(1, 0.0f, 0.0f, 8388629, 5).setMargin(10, 0, 0, 0));
        SparseArray<HyperCellLayout.LayoutParams> sparseArray2 = new SparseArray<>();
        LARGE_PARAMS = sparseArray2;
        sparseArray2.put(R.id.view_auxiliary, generateLayoutParams(2, 0.0f, 1.0f, 16, 0));
        ...
        sparseArray2.put(R.id.area_end, generateLayoutParams(1, 0.0f, 0.0f, 8388629, 5).setMargin(10, 0, 0, 0));
    }
