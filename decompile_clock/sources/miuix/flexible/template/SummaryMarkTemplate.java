...
public class SummaryMarkTemplate extends AbstractMarkTemplate {
    ...
    static {
        ...
        sparseArray.put(R.id.area_title, generateLayoutParams(2, 0.0f, 1.0f, 16, 0));
        sparseArray.put(R.id.area_content, generateLayoutParams(2, 0.0f, 0.0f, 0, 1, 0, 10, 0, 0));
        sparseArray.put(R.id.view_auxiliary, generateLayoutParams(3, 0.0f, 0.0f, 0, 2));
        sparseArray.put(R.id.area_comment, generateLayoutParams(3, 0.0f, 1.0f, 17, 3, 0, 10, 0, 0));
        sparseArray.put(R.id.area_status, generateLayoutParams(3, 0.0f, 0.0f, 16, 4, 10, 10, 0, 0));
        sparseArray.put(R.id.area_end, generateLayoutParams(1, 0.0f, 0.0f, 17, 5, 10, 0, 0, 0));
        SparseArray<HyperCellLayout.LayoutParams> sparseArray2 = new SparseArray<>();
        LARGE_PARAMS = sparseArray2;
        sparseArray2.put(R.id.area_title, generateLayoutParams(2, 0.0f, 1.0f, 16, 0));
        sparseArray2.put(R.id.area_content, generateLayoutParams(2, 0.0f, 0.0f, 0, 1, 0, 10, 0, 0));
        sparseArray2.put(R.id.view_auxiliary, generateLayoutParams(2, 0.0f, 0.0f, 0, 2));
        sparseArray2.put(R.id.area_comment, generateLayoutParams(2, 0.0f, 0.0f, 0, 3, 0, 10, 0, 0));
        sparseArray2.put(R.id.area_status, generateLayoutParams(2, 0.0f, 0.0f, 0, 4, 0, 10, 0, 0));
        sparseArray2.put(R.id.area_end, generateLayoutParams(1, 0.0f, 0.0f, 17, 5, 10, 0, 0, 0));
    }
