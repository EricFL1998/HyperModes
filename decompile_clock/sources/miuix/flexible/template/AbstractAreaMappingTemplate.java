...
public abstract class AbstractAreaMappingTemplate implements IHyperCellTemplate {
        ...
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == R.styleable.HyperCellLayout_viewStub) {
                    this.mIsViewStub = typedArrayObtainStyledAttributes.getBoolean(index, false);
                }
            }
    ...
    public void onFinishInflate(ViewGroup viewGroup) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            ViewGroup viewGroup2 = (ViewGroup) this.mRoot.findViewById(((HyperCellLayout.LayoutParams) layoutParams).getAreaId());
            if (viewGroup2 != null) {
