...
import miuix.appcompat.view.menu.MenuPresenter;
...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    final View.OnClickListener onClickListener = new View.OnClickListener() { // from class: miuix.navigator.navigation.internal.NavigationMenuPresenter.1
    ...
    @Override // miuix.appcompat.view.menu.MenuPresenter
    ...
    public void initForMenu(Context context, MenuBuilder menuBuilder) {
        ...
        this.paddingSeparator = context.getResources().getDimensionPixelOffset(R.dimen.miuix_design_navigation_separator_vertical_padding);
    }

    @Override // miuix.appcompat.view.menu.MenuPresenter
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.menuView == null) {
            NavigationMenuView navigationMenuView = (NavigationMenuView) this.layoutInflater.inflate(R.layout.miuix_design_navigation_menu, viewGroup, false);
            ...
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(R.layout.miuix_design_navigation_item_header, (ViewGroup) this.menuView, false);
    ...
    private static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(R.layout.miuix_design_navigation_item_subheader, viewGroup, false));
        }
    }

    private static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(R.layout.miuix_design_navigation_item_separator, viewGroup, false));
        }
    }
    ...
    private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            ViewCompat.setBackground(navigationMenuItemView, (NavigationMenuPresenter.this.itemBackground == null || NavigationMenuPresenter.this.itemBackground.getConstantState() == null) ? null : NavigationMenuPresenter.this.itemBackground.getConstantState().newDrawable());
            if (NavigationMenuPresenter.this.itemForeground != null) {
                navigationMenuItemView.setForeground(NavigationMenuPresenter.this.itemForeground.getConstantState() != null ? NavigationMenuPresenter.this.itemForeground.getConstantState().newDrawable() : null);
            }
        ...
        private void setAccessibilityDelegate(View view, final int i, final boolean z) {
            ViewCompat.setAccessibilityDelegate(view, new AccessibilityDelegateCompat() { // from class: miuix.navigator.navigation.internal.NavigationMenuPresenter.NavigationMenuAdapter.1
    ...
    private class NavigationMenuViewAccessibilityDelegate extends RecyclerViewAccessibilityDelegate {
        NavigationMenuViewAccessibilityDelegate(miuix.recyclerview.widget.RecyclerView recyclerView) {
            super(recyclerView);
        }
