    ...
    public void refreshViewShadow(View view) {
        if (this.mEnableMiShadow) {
            if (this.mEnableShadow) {
                MiShadowUtils.setMiShadow(view, this.mShadowColor, this.mOffsetXPx, this.mOffsetYPx, this.mBlurRadiusPx, this.mDropShadowConfig.shadowDispersion, this.mDropShadowConfig.clipShadowEnable);
                return;
            } else {
