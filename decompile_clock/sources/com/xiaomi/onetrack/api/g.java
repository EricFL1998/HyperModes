...
public class g {
    ...
    public static final String ad = "exp_id";
    public static final String ae = "onetrack_dau";
    public static final String af = "view";
    public static final String ag = "ot_login";
    public static final String ah = "ot_logout";
