...
public interface IClockService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IClockService {
        private static final String DESCRIPTOR = "com.xiaomi.smarthome.binder.IClockService";
        static final int TRANSACTION_notifySleepChange = 1;
        ...
        public static IClockService asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IClockService)) {
                return (IClockService) iInterfaceQueryLocalInterface;
            }
        ...
        private static class Proxy implements IClockService {
