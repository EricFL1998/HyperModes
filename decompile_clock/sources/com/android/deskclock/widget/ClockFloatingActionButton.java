...
public class ClockFloatingActionButton extends ImageButton {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.mFabSize = iMin;
        this.mWidth = iMin + (getShadowX() * 2);
        int shadowY = this.mFabSize + (getShadowY() * 2);
        this.mHeight = shadowY;
        setMeasuredDimension(this.mWidth, shadowY);
    }
    ...
    private void updateBackground() {
        ...
        int i = (this.mFabSize - (iMax > 0 ? iMax : 0)) / 2;
        int i2 = iAbs + i;
        int i3 = i + iAbs2;
    ...
    private class ShadowDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            if (ClockFloatingActionButton.this.mTransparentMode) {
                Bitmap bitmapCreateBitmap = Bitmap.createBitmap(ClockFloatingActionButton.this.mWidth, ClockFloatingActionButton.this.mHeight, Bitmap.Config.ARGB_8888);
                ...
                Bitmap bitmapCreateBitmap2 = Bitmap.createBitmap(ClockFloatingActionButton.this.mWidth, ClockFloatingActionButton.this.mHeight, Bitmap.Config.ARGB_8888);
                ...
                Bitmap bitmapCreateBitmap3 = Bitmap.createBitmap(ClockFloatingActionButton.this.getWidth(), ClockFloatingActionButton.this.getHeight(), Bitmap.Config.ARGB_8888);
                Canvas canvas4 = new Canvas(bitmapCreateBitmap3);
                Paint paint = new Paint();
                canvas4.drawBitmap(bitmapCreateBitmap, 0.0f, 0.0f, paint);
                paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
                canvas4.drawBitmap(bitmapCreateBitmap2, 0.0f, 0.0f, paint);
