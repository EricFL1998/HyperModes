...
final class ColorResourcesTableCreator {
    ...
    private static class PackageChunk {
        ...
        void writeTo(ByteArrayOutputStream byteArrayOutputStream) throws IOException {
            ...
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(R2.attr.actionSheetListView));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(this.typeStrings.getChunkSize() + R2.attr.actionSheetListView));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
        ...
        int getChunkSize() {
            return this.typeStrings.getChunkSize() + R2.attr.actionSheetListView + this.keyStrings.getChunkSize() + this.typeSpecChunk.getChunkSizeWithTypeChunk();
        }
    }
