...
public final class CalendarConstraints implements Parcelable {
    ...
    public static final class Builder {
        ...
        static final long DEFAULT_START = UtcDates.canonicalYearMonthDay(Month.create(R2.attr.preferenceItemPaddingTop, 0).timeInMillis);
        static final long DEFAULT_END = UtcDates.canonicalYearMonthDay(Month.create(R2.attr.sliderOff, 11).timeInMillis);
