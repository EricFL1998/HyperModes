...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final int[] DURATION_TO_MOVE_SEGMENT_ENDS = {R2.attr.checkableButtonTextColor, R2.attr.chipBackgroundColor, R2.attr.disableDependentsState, R2.attr.contentPaddingStart};
    private static final int[] DELAY_TO_MOVE_SEGMENT_ENDS = {R2.attr.justifyContent, 1000, R2.attr.arrowShaftLength, 0};
