...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public Buffer writeUtf8(String str, int i, int i2) {
        ...
        while (i < i2) {
            ...
            if (cCharAt < 128) {
                ...
                if (cCharAt < 2048) {
                    writeByte((cCharAt >> 6) | R2.attr.actionBarItemBackground);
                    writeByte((cCharAt & '?') | 128);
                } else if (cCharAt < 55296 || cCharAt > 57343) {
                    writeByte((cCharAt >> '\f') | R2.attr.actionBarStyle);
                    ...
                    if (cCharAt > 56319 || cCharAt3 < 56320 || cCharAt3 > 57343) {
                        ...
                        writeByte((i7 >> 18) | R2.attr.actionBarTitleColor);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writeByte((i >> 6) | R2.attr.actionBarItemBackground);
            writeByte((i & 63) | 128);
        } else if (i < 65536) {
            if (i >= 55296 && i <= 57343) {
                writeByte(63);
            } else {
                writeByte((i >> 12) | R2.attr.actionBarStyle);
                writeByte(((i >> 6) & 63) | 128);
                writeByte((i & 63) | 128);
            }
        } else if (i <= 1114111) {
            writeByte((i >> 18) | R2.attr.actionBarTitleColor);
    ...
    public Buffer writeDecimalLong(long j) {
        ...
        if (j < 100000000) {
            ...
            } else if (j < FolmeCore.NANOS_TO_MS) {
                i = j < 100000 ? 5 : 6;
            } else {
                i = j < 10000000 ? 7 : 8;
            }
    ...
    public final ByteString sha1() {
        return digest(DigestUtils.ALGORITHM_SHA_1);
    }
